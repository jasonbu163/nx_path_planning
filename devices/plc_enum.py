...
class PLCAddress(PLCAddressBase, Enum):
    ...
    PLATFORM_PALLET_READY_MAN = 53.0
...
if __name__ == "__main__":
    # 访问整型点位
    print(PLCAddress.START_LAYER.name)  # 输出: 2 (int类型)
    
    # 访问浮点型点位
    print(PLCAddress.FEED_COMPLETE_1010.value)  # 输出: 22.0 (float类型)
