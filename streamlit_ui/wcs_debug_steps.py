...
page_steps = {
    "📥 入库操作": [
        {
            ...
            "api": "/api/v1/wcs/control/task_lift_inband",
            "method": "GET",
            "params": {}
        },
        {
        ...
        },
        {
            ...
            "api": "/api/v1/wcs/control/task_out_lift",
            "method": "POST",
            "params": {
                "location_id": 1
            }
        ...
        {
            "title": "步骤 5：入库完成确认",
            "api": "/api/v1/wcs/control/task_pick_complete",
            "method": "POST",
            "params": {
                "location_id": 1
            }
    ...
    "🚚 小车跨层": [
        {
            "title": "步骤 1：操作小车移动",
            "api": "/api/v1/wcs/control/car_move_segments",
            "method": "POST",
            "params": {
                "source": "1,1,1",
                "target": "6,3,1",
